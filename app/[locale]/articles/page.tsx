...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  if (locale !== "en") return {};
  const metadata = localizedMetadata("en", "/articles", "Science Learning Articles: AI, Study Skills & Teaching", "Practical articles for students and teachers: use AI thoughtfully, check science answers, plan lessons, and test ideas in free interactive simulations.", { englishOnly: true });
