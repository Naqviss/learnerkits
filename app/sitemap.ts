...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const isEnglishOnly = (path: string) => path.startsWith("/guides") || path.startsWith("/articles");
  ...
  return locales.flatMap((locale) => {
    ...
    const paths = locale === defaultLocale ? [...core, ...subjectPaths, ...simulationPaths, ...topicGuidePaths, ...articlePaths] : [...core, ...subjectPaths, ...simulationPaths];
